...
void settingsMenu() {
	...
	do {
		...
		for (int i = 0; i < temp_sett_choice.length(); i++) //data validation for prevent run-time-error
		{
			if (i == 2)
			{
				break;
		...
		if (sett_choice[1] == '\0') //data validation
		{
...
void instructions() {
	...
	do {
		...
		for (int i = 0; i < temp_instruct_choice.length(); i++) //data validation for prevent run-time-error
		{
			if (i == 2)
			{
				break;
		...
		system("cls");
		if (instruct_choice[1] == '\0') //data validation
		{
...
int main() {
	...
	do	// Main meun
	{
		...
		for (int i = 0; i < temp_user_choice.length(); i++) //data validation for prevent run-time-error
		{
			if (i == 2)
			{
				break;
		...
		while (user_choice[1] != '\0') //data validation
		{
			system("cls");
			user_choice[1] = '\0';
			cout << "Yb        dP       8                                w             w   8              .d88b             8    w               .d88b                       8 8 8 " << endl;
